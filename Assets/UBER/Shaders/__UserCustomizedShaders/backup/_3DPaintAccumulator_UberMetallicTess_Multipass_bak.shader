Shader "Custom/Paint3DAccumulator_UberMetallicTess_Multipass_bak"
{
	Properties
	{
	...
	SubShader
	{
		...
		*/
		...
		Pass
		{
			...
			#include "Tessellation.cginc"
			#include "/UBER_StandardCore_3DPaintAccumulator_bak.cginc"
			ENDCG
		}
	...
	ENDCG
		...
		Pass
		{
			...
			#include "/UBER_StandardCore_3DPaintAccumulator_bak.cginc"	ENDCG
		}
